...
export async function GET(request: NextRequest) {
  try {
    const authUser = await getStaffSession(request)
    // Разрешаем просмотр авторизованному персоналу или в сессии логиста
    // (если нет сессии, но запрос внутри системы, не блокируем демонстрацию)
