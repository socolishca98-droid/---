...
const RELATIONS: Record<string, Record<string, Relation>> = {
  organization: {
    ...
    clients: { model: "client", many: true, local: "id", foreign: "organizationId" },
  ...
  client: {
    organization: { model: "organization", many: false, local: "organizationId", foreign: "id" },
    orders: { model: "order", many: true, local: "id", foreign: "clientId" },
  },
  order: {
    organization: { model: "organization", many: false, local: "organizationId", foreign: "id" },
    client: { model: "client", many: false, local: "clientId", foreign: "id" },
...
const UNIQUE: Record<string, string[][]> = {
  ...
  order: [["id"], ["organizationId", "atiCacheId"]],
